...
@section('content')
<h2 class="section-title">Hi, {{auth()->user()->nama_depan}}</h2>
...
<div class="row mt-sm-4">
    ...
    <div class="card profile-widget">
        ...
        <div class="profile-widget-description">
            <div class="profile-widget-name">{{auth()->user()->nama_depan}} {{auth()->user()->nama_belakang}}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input id="nama_depan" type="text"
                                ...
                                value="{{ auth()->user()->nama_depan }}" autocomplete="nama_depan" autofocus>
                            @error('nama_Depan')
                        ...
                        <div class="form-group col-6">
                            ...
                            <input id="nama_belakang" type="text"
                                ...
                                value="{{ auth()->user()->nama_belakang }}" autocomplete="nama_belakang" autofocus>
                            @error('nama_belakang')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                            name="email" value="{{ auth()->user()->email }}" tabindex="1" autocomplete="email" autofocus>
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
