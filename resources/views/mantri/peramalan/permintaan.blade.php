                ...
                <table id="kecamatan" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('forecast.permintaan.proses', $k->id) }}" class="btn btn-sm btn-icon icon-left btn-primary modalKecamatan"></i> {{__("Ramal Data")}}</a>
                            </td>
                            <?php $no++ ?>
                        </tr>
                        @endforeach
...
{{-- @section('modal')
@foreach ($kecamatan as $k)
<form method="POST" action="{{ route('forecast.permintaan.proses', $k->id) }}" class="modal-part" id="formpermintaanKecamatan-{{$k->id}}">
    @csrf
...
{{-- $('.modalKecamatan').click(function () {
    ...
    $("#modalKecamatan-"+id).fireModal({
        title: 'Form Peramalan permintaan',
        body: $("#formpermintaanKecamatan-"+id),
