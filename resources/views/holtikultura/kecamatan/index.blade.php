        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('kec.create') }}" class="btn btn-primary">{{__("Tambah")}}</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="kecamatan" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$k->nama}}</td>
                                <td>
                                    <a href="{{ route('kec.edit', $k->id) }}" class="btn btn-sm btn-icon icon-left btn-primary"><i class="far fa-edit"></i> {{__("Ubah")}}</a>
                                    <a href="{{ route('kec.destroy', $k->id) }}"
