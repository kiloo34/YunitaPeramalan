...
@section('content')
<h2 class="section-title">Hi, {{auth()->user()->mantri->nama_depan}}</h2>
...
<div class="row mt-sm-4">
    ...
    <div class="card profile-widget">
        <div class="profile-widget-header">
            <img alt="image" src="{{auth()->user()->mantri->avatar}}" class="rounded-circle profile-widget-picture">
        </div>
        <div class="profile-widget-description">
            <div class="profile-widget-name">{{auth()->user()->mantri->nama_depan}} {{auth()->user()->mantri->nama_belakang}}
    ...
    <div class="col-12 col-md-12 col-lg-7">
        <div class="card">
            <form action="{{ route('mantri.update', auth()->user()->id) }}" method="post" class="needs-validation" novalidate="">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input id="nama_depan" type="text"
                                ...
                                value="{{ auth()->user()->mantri->nama_depan }}" autocomplete="nama_depan" autofocus>
                            @error('nama_Depan')
                        ...
                        <div class="form-group col-6">
                            ...
                            <input id="nama_belakang" type="text"
                                ...
                                value="{{ auth()->user()->mantri->nama_belakang }}" autocomplete="nama_belakang" autofocus>
                            @error('nama_belakang')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
