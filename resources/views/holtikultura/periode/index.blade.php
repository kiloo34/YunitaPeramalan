    ...
    <div class="col-md-12 ">
        <div class="card">
            <div class="card-header">
                <h4>{{__("Daftar Periode")}}</h4>
                <div class="card-header-action">
                    <a href="{{ route('period.create') }}" class="btn btn-primary">{{__("Tambah")}}</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="periode" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$p->tahun}}</td>
                                <td>
                                    <a href="{{ route('period.edit', $p->id) }}" class="btn btn-sm btn-icon icon-left btn-primary"><i class="far fa-edit"></i> {{{__("Ubah")}}}</a>
